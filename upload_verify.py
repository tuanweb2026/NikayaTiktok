...
def upload_and_verify():
    print("Starting upload and verification process...")
    ...
    with sync_playwright() as p:
        ...
        page.screenshot(path=os.path.join(OUTPUT_DIR, "before_post.png"))
        ...
        # Track progress
        print("Waiting 5s after click...")
        page.wait_for_timeout(5000)
        page.screenshot(path=os.path.join(OUTPUT_DIR, "post_clicked_5s.png"))
        
        print("Waiting 15s after click...")
        page.wait_for_timeout(10000)
        page.screenshot(path=os.path.join(OUTPUT_DIR, "post_clicked_15s.png"))
