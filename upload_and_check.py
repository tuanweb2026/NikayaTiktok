...
def upload_and_check():
    print("Starting upload and verify content list process...")
    ...
    with sync_playwright() as p:
        ...
        # Dismiss exit warning dialog to finalize redirect
        try:
        ...
        screenshot_path = os.path.join(OUTPUT_DIR, "after_post_content_list.png")
